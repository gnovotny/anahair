...
import { OpeningHours } from '@/components/common/info'
...
export default function OpeningHoursPage() {
  ...
  return (
    <>
      <NextSeo title={t('opening_hours_long')} />
      <div
        className={cn(
...
export const getStaticProps = buildStaticPropsGetterWithTitle('opening_hours_long')
